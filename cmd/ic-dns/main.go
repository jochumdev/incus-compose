	...
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_TOKEN"),
			},
			&cli.StringFlag{
				Name: "data-dir",
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_DATA_DIR"),
			},
			&cli.StringFlag{
				Name:        "secrets-dir",
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_SECRETS_DIR"),
			},
			&cli.StringFlag{
				Name:        "client-cert",
				Usage:       "Certificate to present instead of enrolling; needs --client-key",
				Destination: &cfg.ClientCert,
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_CLIENT_CERT"),
			},
			&cli.StringFlag{
				Name:        "client-key",
				Usage:       "Key for --client-cert",
				Destination: &cfg.ClientKey,
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_CLIENT_KEY"),
			},
			&cli.BoolFlag{
				Name:        "restricted",
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_RESTRICTED"),
			},
			&cli.StringFlag{
				Name:        "remote",
			...
			&cli.BoolFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_USE_REMOTE"),
			},
			...
			&cli.StringSliceFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_PROJECTS"),
			},
			&cli.StringFlag{
				Name:    "project-marker",
			...
			&cli.DurationFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_DEBOUNCE_WINDOW"),
			},
			&cli.IntFlag{
				Name:        "workers",
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_WORKERS"),
			},
			&cli.DurationFlag{
				Name:        "read-timeout",
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_READ_TIMEOUT"),
			},
			&cli.DurationFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_SWEEP_PROJECT_DELAY"),
			},
			&cli.DurationFlag{
			...
			&cli.StringSliceFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_EXCLUDE"),
			},
			...
			&cli.StringFlag{
				...
				Destination: &cfg.Log,
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_LOG"),
			},
			...
			&cli.BoolFlag{
				...
				Sources:     cli.EnvVars("INCUS_COMPOSE_DNS_PPROF"),
			},
		},
